<%@ Page Title="" Language="C#" MasterPageFile="~/RestrictedArea/Templates/Layout.Master" AutoEventWireup="true" CodeBehind="ModifyBook.aspx.cs" Inherits="Projeto.Web.RestrictedArea.ModifyBook" %>
<asp:Content ID="Content1" ContentPlaceHolderID="conteudoPrincipal" runat="server">
    ...
    />
    <br /><br />
    <h3 class="text-center">Edição de Livros</h3>
    <hr />

    <div class="row">
        <div class="col-md-4">
            <label>Id do Livro</label>
            <asp:TextBox ID="txtBookId" runat="server" CssClass="form-control" Required="Required" ReadOnly="true"/>            
            <label>Título do Livro</label>
            <asp:TextBox ID="txtTitle" runat="server" CssClass="form-control" Required="Required" />
        ...
        <div class="col-md-4">
           ...
           AlternateText="Capa do Livro"
           ImageAlign="left" cssClass="img-200-200"/>
        ...
        <div class="col-md-12">
            <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary" Text="Atualizar Livro" OnClick="btnModify_Click"/>
            <br /><br />

            <asp:Label ID="lblMsg" runat="server" CssClass="label-success"></asp:Label>
        </div>
    </div>
